          ...
          <div className="relative grid grid-cols-1 gap-16 md:grid-cols-2">
            ...
            <div className="relative">
              <div className="relative h-96 w-full">
                ...
                <div className="absolute -top-6 -left-6 w-32 h-32 bg-blue-900/30 rounded-full opacity-70 z-0"></div>
                <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-blue-900/20 rounded-full opacity-60 z-0"></div>
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      isActive(index) ? "bg-blue-500 scale-125" : "bg-gray-600"
                    }`}
            ...
            <div className="flex flex-col justify-center">
              <div className="bg-gray-800 rounded-3xl shadow-lg p-8 relative border border-gray-700">
                {/* Quote icon */}
                <div className="absolute -top-5 -left-5 bg-blue-600 text-white p-3 rounded-full shadow-md">
                  <svg 
                    className="w-6 h-6" 
                    fill="currentColor" 
                    viewBox="0 0 24 24" 
                ...
                >
                  ...
                  <div className="mt-8 flex items-center border-t border-gray-700 pt-4">
                    ...
                    <div className="flex space-x-3">
                      <button
                        onClick={handlePrev}
                        className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-700 text-white hover:bg-blue-800 transition-colors duration-300"
