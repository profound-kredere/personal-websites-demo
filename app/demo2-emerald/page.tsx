...
import AnimatedTestimonials2 from "@/components/ui/animated-testimonials2";
...
export default function MFDTemplate() {
  ...
  const testimonials = [
  {
    quote: "Aman guided me through my first mutual fund investments with patience and expertise. His personalized approach helped me create a balanced portfolio that's grown by 18% in just 14 months despite market volatility.",
    name: "Priya Sharma",
    designation: "IT Professional, Investing since 2021",
    gender: "female" as const,
  },
  {
    quote: "After trying to manage investments on my own for years, Aman's strategic SIP recommendations have been transformative. His in-depth knowledge helped me set up a tax-efficient portfolio that's consistently outperforming my previous investments.",
    name: "Vikram Malhotra",
    designation: "Business Owner, Investing since 2019",
    gender: "male" as const,
  },
  {
    quote: "What impressed me most about Aman is his honest approach to mutual fund selection. He recommended funds based on my risk profile and goals, not just the ones with highest commissions. My retirement corpus has grown steadily thanks to his guidance.",
    name: "Sunita Patel",
    designation: "School Principal, Investing since 2017",
    gender: "female" as const,
  },
  {
    quote: "I was hesitant about investing in mutual funds until I met Aman. He took the time to educate me about the market cycles and helped me set up SIPs that perfectly align with my children's education goals. The regular portfolio reviews keep me confident.",
    name: "Rahul Khanna",
    designation: "Healthcare Professional, Investing since 2020",
    gender: "male" as const,
  },
  {
    quote: "Aman helped me navigate through complex mutual fund categories and select the right mix for my financial goals. His goal-based approach and regular rebalancing suggestions have significantly improved my portfolio's performance.",
    name: "Anjali Mehta",
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 font-sans">
      ...
      <header className="sticky top-0 z-10 bg-gray-900/90 backdrop-blur-sm border-b border-gray-800">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <h1 className="text-2xl font-bold text-emerald-400">Aman Gupta</h1>
          </div>
      ...
      <section className="py-5 bg-gradient-to-r from-gray-900 to-emerald-900">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <div className="mb-4">
              <span className="bg-emerald-900/60 text-emerald-300 text-sm font-medium px-4 py-1.5 rounded-full">
                AMFI Registered Mutual Fund Distributor | ARN-21328
              </span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Building Wealth Through{" "}
              <span className="text-emerald-400">Disciplined Investing</span>
            </h1>
            ...
            <div className="flex space-x-4">
              <button className="px-6 py-3 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition">
                Start Investing
              </button>
              <button className="px-6 py-3 border border-emerald-600 text-emerald-400 rounded-md hover:bg-emerald-900/50 transition">
                Free Consultation
              </button>
            </div>
            ...
            <div className="mt-10 grid grid-cols-2 gap-4">
              <div className="flex items-center">
                <div className="flex-shrink-0 bg-emerald-900/80 p-2 rounded-full shadow-sm">
                  <svg
          ...
          <div className="md:w-1/2 relative">
            ...
            <div className="bg-gray-800 p-6 rounded-3xl shadow-xl relative md:ml-12 border border-gray-700">
              <div className="absolute top-0 right-0 bg-emerald-400 text-gray-800 rounded-full p-2 transform translate-x-1/4 -translate-y-1/4">
                <svg
                  className="w-5 h-5"
                  fill="none"
                  stroke="currentColor"
              ...
              <div className="mt-6 bg-gray-900/50 rounded-xl p-4 border border-gray-700">
                <div className="flex items-center">
                  <div className="flex-shrink-0 bg-emerald-600 p-2 rounded-full mr-4">
                    <svg
                  ...
                  <div>
                    ...
                    <p className="text-emerald-400">Mutual Fund Distributor</p>
                  </div>
                </div>
            ...
            {/* Decorative elements */}
            <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-64 h-64 bg-emerald-800/40 rounded-full -z-10 opacity-60 blur-xl"></div>
            <div className="absolute bottom-0 right-0 w-40 h-40 bg-emerald-700/40 rounded-full -z-10 opacity-70 blur-lg"></div>
            <div className="absolute top-0 right-1/4 w-20 h-20 bg-emerald-900/30 rounded-full -z-10 opacity-60 blur-md"></div>
          </div>
        </div>
      </section>
            ...
            <div className="rounded-lg border border-gray-700 bg-gray-800/50 shadow-sm hover:shadow-md transition-shadow duration-200">
              <div className="flex flex-col space-y-1.5 p-6">
                <div className="flex items-center gap-2">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-emerald-900/20 text-emerald-400">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
              ...
              <div className="flex items-center p-6 pt-0">
                <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-emerald-700 text-gray-100 hover:bg-emerald-700/90 h-10 px-4 py-2">
                  Learn More
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
      ...
      <section id="investment-approach" className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Philosophy 1 */}
            <div className="bg-gray-800 rounded-lg p-6 border-t-4 border-emerald-500 shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-700">
              ...
              <div className="flex justify-between items-center">
                <span className="text-emerald-400">Large & Mid Cap</span>
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-700">
              ...
              <div className="flex justify-between items-center">
                <span className="text-emerald-400">Balanced Allocation</span>
          ...
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="md:w-1/2">
              <form className="bg-gray-900 rounded-lg border border-gray-700 p-6">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition"
                >
      ...
      {/* Call to Action */}
      <section className="py-16 bg-gradient-to-r from-emerald-900 to-emerald-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="px-8 py-4 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition text-lg font-semibold">
              Start Investing Now
            </button>
