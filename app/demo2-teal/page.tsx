  ...
  <div className="container mx-auto px-4">
    ...
    <div className="mt-10 text-center">
     ...
     <AnimatedTestimonials2 testimonials={testimonials} autoplay={true} />
          ...
          <div className="flex flex-col md:flex-row gap-10">
            <div className="md:w-1/2">
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-teal-900 rounded-full flex items-center justify-center mr-4">
                    <svg
            ...
            <div className="md:w-1/2">
              <form className="bg-gray-900 rounded-lg border border-gray-700 p-6">
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-teal-600 text-white rounded-md hover:bg-teal-700 transition"
                >
      ...
      {/* Call to Action */}
      <section className="py-16 bg-gradient-to-r from-teal-900 to-teal-600">
